...
Notes
- The landing HTML already includes preload hints for the hero image (`/img/hero-bg.jpg`) and the Montserrat font. These were intentionally left as-is (critical resources).
